...
namespace Clases_MT
{
    public class Class1
    {
        ...
        public void Movimiento(ref string alfabeto, Dictionary<string, string> Diccionario, ref int posicion, ref int actual, ref string ultima, ref List<string> transiciones, ref List<string> cint)
        {
            posicion = 0;
